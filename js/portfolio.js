...
function portfolioPopup(e) {
	...
	if (e.target instanceof HTMLDivElement) {
		let popup = e.target.parentElement.getElementsByClassName("portfolio_popup")[0];
		popup.style.display = "block";
	} 
	else if (e.target.parentElement instanceof HTMLHeadingElement){
		let popup = e.target.parentElement.parentElement.parentElement.getElementsByClassName("portfolio_popup")[0];
		popup.style.display = "block";
	}
	else {
		let popup = e.target.parentElement.parentElement.getElementsByClassName("portfolio_popup")[0];
		popup.style.display = "block";
	}
}
